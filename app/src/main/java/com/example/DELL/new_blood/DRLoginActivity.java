        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if((mEmailView.getText().toString() != null && !mEmailView.getText().toString().isEmpty()) && (mPasswordView.getText().toString() != null && !mPasswordView.getText().toString().isEmpty())) {
                    ...
                    d = new Downloader5(DRLoginActivity.this, mEmailView.getText().toString(), mPasswordView.getText().toString(), address);
                    d.execute();
                }else{
...
class Downloader5 extends AsyncTask<Void,Integer,String> {
    ...
    public Downloader5(Context c, String email, String password, String address) {
        this.c = c;
...
//                ImLoggedIn.putExtra("USER_ID", s);
//                ImLoggedIn.putExtra("name", s);
//                ImLoggedIn.putExtra("email", email);
                c.startActivity(ImLoggedIn);
